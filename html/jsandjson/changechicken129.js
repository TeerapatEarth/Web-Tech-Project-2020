...
function chicken1() {
    ...
    if (chic2 == 1) {
        ...
        btn2.style = "color: white; background-color: black; width: 264px; height: 40px; border: none;"
        chic2 = 0
        chic3 = 0
        pic.innerHTML = "<img src='https://cdn.1112.com/1112/public/images/products/maindish/mobile/itm116535.png' style='width: 45%;'>"
...
function chicken3() {
    ...
    if (chic3 == 0) {
        btn.style = "color: white; background-color: hsl(139, 69%, 22%); width: 285px; height: 40px; border: none;"
        btn2.style = "color: white; background-color: hsl(139, 69%, 22%); width: 264px; height: 40px; border: none;"
        chic3 = 1
        chic2 = 1
