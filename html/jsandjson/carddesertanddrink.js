let requestURL = 'dessertanddrinkjson.json';
...
function dataReportStatus(data) {
    let box = document.getElementById("dessertanddrink");
    for (let i = 0; i < 15; i++) {
        if (i >= 0 && i < 3) {
            box.innerHTML += "<div class='col-md-3'><div class='card'\
         style='background-color: black; border-radius: 20px; margin: 10px; height: 255px;'>\
        <img src='"+ data[i].img + "' style='width: 90%; margin-top: 10px; margin-left: 12px; margin-bottom: 27px; border-radius: 20px;'>\
        <p style='text-align: center;font-size: 11px;'>" + data[i].name + "</p>\
